...
function remove_admin_menu_links(){
    ...
    if( $user && isset($user->user_email) && 'systemadmin@romeopower.com' == $user->user_email ) {
...
$address_fields['postcode']['label'] = 'Zip';
$address_fields['billing_postcode']['label'] = 'Zip';
...
/*
ENQUEUE SCRIPTS AND STYLES FOR GREENHOUSE JOBS
*/
function enqueue_greenhouse() {

	// JQUERY
	wp_enqueue_script( 'jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js', array(), '3.3.1', true );

	// GOOGLE FONTS: 'ROBOTO'
	wp_enqueue_style( 'google_fonts', 'https://fonts.googleapis.com/css?family=Roboto', array(), '1.0.0' );

	// GOOGLE MATERIAL ICONS
	wp_enqueue_style( 'google_material_icons', 'https://fonts.googleapis.com/icon?family=Material+Icons', array(), '1.0.0' );

	// GREENHOUSE CSS
	wp_enqueue_style( 'romeo_greenhouse_css', get_stylesheet_directory_uri() . '/greenhouse_api/css/style.css', array(), '4.7.0' );

	// GREENHOUSE SCRIPT
	wp_enqueue_script( 'romeo_greenhouse_js', get_stylesheet_directory_uri() . '/greenhouse_api/js/scripts.js', array(), '1.0.1', false );

}

add_action( 'wp_enqueue_scripts', 'enqueue_greenhouse' );
